...
@Component
public class Managedetatcaisse implements Serializable {
	...
	private static Logger logger = Logger.getLogger(Managedetatcaisse.class);
...
// geters et seters
	...
	public List<Facture> getListefacture() {
		...
		if (listefacture.isEmpty()) {
			listefacture = getObjectService().getObjects("Facture");
		}
		return listefacture;
	}
